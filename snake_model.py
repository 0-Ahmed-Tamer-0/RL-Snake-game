...
Original file is located at
    https://colab.research.google.com/drive/1OR1ZQgNhIvephk02-EHDtuJLvLWgeixr
"""
...
class QNetwork(nn.Module):
    ...
    def predict(self, state) -> torch.Tensor:
        ...
        with torch.no_grad():
            tensor = self._to_tensor(state)           # shape: (1, input_size)
            q_values = self.network(tensor)            # shape: (1, output_size)
            return q_values.squeeze(0)                 # shape: (output_size,)
